...
export class TableLayout {
  _defaultAlignment: any;
_defaultStretch: any;
_rowDefs: any;
_colDefs: any;
cloneProtected: any;
getRowDefinition: any;
getColumnDefinition: any;
getEffectiveTableStretch: any;
doLayout: any;
measureTable: any; 
arrangeTable: any;
  ngOnInit(): void {
...
/** @ignore */
TableLayout.prototype.cloneProtected = function(copy: any) {
...
*/
function getRowDefinition(idx: any) {
...
* @return {RowColumnDefinition}
*/
function getColumnDefinition(idx: any) {
...
* @return {EnumValue}
*/
TableLayout.prototype.getEffectiveTableStretch = function(child: any, row: any, col: any) {
  ...
  // undefined = default
  var horizontal: any = undefined;
  var vertical: any = undefined;
  switch (row.stretch) {
...
* @this {TableLayout}
*/
TableLayout.prototype.measureTable = function(width: any, height: any, children: any, union: any, minw: any, minh: any) {
  var l = children.length;
  // Make the array that holds [rows][cols] of the table
  var rowcol: any = []; // saved (so no temp array) starts as an array of rows, will end up [row][col][cell]
  for (var i = 0; i < l; i++) {
  ...
  var resetCols: any = [];  // keep track of which columns we've already reset
  ...
  var desiredColTotal = 0.0;
   { if (i !== 0 ) desiredRowTotal += nosizeRows[i] }
   { if (i !== 0) desiredColTotal += nosizeCols[i] }
...
* @this {TableLayout}
*/
TableLayout.prototype.arrangeTable = function(children: any, union: any, rowcol: any) {
  var l = children.length;
